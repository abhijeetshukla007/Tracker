...
## Generated Story -9650141473873762
...
## Generated Story 627845059024612069
* create.todolist
    - utter_ask_todo_list_name
* input.list.name{"todo-list-name": "my list"}
    - slot{"todo-list-name": "my list"}
    - action_create_todo_list
    - utter_ask_taskName
* add.task.todo.list{"task-name": "meditation"}
    - slot{"task-name": "meditation"}
    - action_add_task_to_list
    - utter_askAnotherTaskToAdd
* smalltalk.confirmation.no
    - utter_createdTodolist.addTask - no-response
    - action_restart

## Generated Story 8639956277240425605
* create.todolist{"todo-list-name": "my list"}
    - slot{"todo-list-name": "my list"}
    - action_create_todo_list
    - utter_ask_taskName
* add.task.todo.list{"task-name": "exercise"}
    - action_add_task_to_list
    - utter_askAnotherTaskToAdd
* smalltalk.confirmation.yes
    - utter_create.todolist.addTask - yes-response
* add.task.todo.list{"task-name": "exercise"}
    - action_add_task_to_list
    - utter_askAnotherTaskToAdd
* smalltalk.confirmation.no
...
## Generated Story -368889597786399714
* retrieve.todolist{"todo-list-name": "my list"}
    - slot{"todo-list-name": "my list"}
    - action_retrieve_todo_list
    - action_restart

## Generated Story -5874130281176028832
* retrieve.todolist
    - utter_ask_todo_list_name
* input.list.name{"todo-list-name": "my tasks"}
    - slot{"todo-list-name": "my tasks"}
    - action_retrieve_todo_list
    - action_restart


## Generated Story 5973281393729161783
* add.task.todo.list{"task-name": "exercise", "todo-list-name": "sample list"}
    - slot{"task-name": "exercise"}
    - slot{"todo-list-name": "sample list"}
    - action_add_task_to_list
    - action_restart

## Generated Story -8676782509278806474
* add.task.todo.list{"task-name": "meditation"}
    - slot{"task-name": "meditation"}
    - utter_ask_todo_list_name
* input.list.name{"todo-list-name": "daily tasks"}
    - slot{"todo-list-name": "daily tasks"}
    - action_add_task_to_list
    - action_restart


## Generated Story 6938100609203671001
* add.task.todo.list{"task-name": "morning walk", "todo-list-name": "sample list"}
    - slot{"task-name": "morning walk"}
    - slot{"todo-list-name": "sample list"}
    - action_add_task_to_list
    - action_restart
